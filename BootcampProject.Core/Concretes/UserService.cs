...
namespace BootcampProject.Core.Concretes
{
    public class UserService : IUserService
    {
        ...
        public UserService(IRepository<ApplicationUser> repository, IUnitOfWork unitOfWork, UserManager<ApplicationUser> userManager)
        {
        ...
        public ResponseDto AddUser(ApplicationUser entity)
        {
        ...
        public List<ApplicationUser> GetPagedUsersAsync(int page)
        {
        ...
        public ResponseDto UpdateUser(ApplicationUser entity)
        {
            var user = _repository.GetById(entity.Id);
